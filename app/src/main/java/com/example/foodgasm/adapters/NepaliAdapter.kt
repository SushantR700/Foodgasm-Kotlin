...
class NepaliAdapter:RecyclerView.Adapter<NepaliAdapter.NepaliViewHolder>() {

    inner class NepaliViewHolder(val binding:CategoryRvItemBinding ):RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NepaliViewHolder {
        return NepaliViewHolder(
    ...
    override fun onBindViewHolder(holder: NepaliViewHolder, position: Int) {
